...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  // Hardware objects (protected for sim subclass access)
  ...
  public ModuleIOTalonFX(
    ...
    // Subtract 0.25 rotations (90°) to shift encoder zero from old-forward to new-forward
    // (robot front rotated 90° CW: old right side = new front)
    // Only on real robot — sim modules have no physical rotation
    cancoderConfig.MagnetSensor.MagnetOffset = edu.wpi.first.wpilibj.RobotBase.isReal()
        ? constants.EncoderOffset - 0.25
